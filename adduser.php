   ...
   <div class="form-container">
      ...
      <form action="" method="post">
         ...
         <select name="cname" style='display:'>
            ...
            <option id="c3" style='display:none' value="Bachelor of Environmental Science">Bachelor of Environmental
               Science</option>
            <option id="c4" style='display:none' value="Advanced Diploma of Engineering">Advanced Diploma of Engineering
            </option>
            <option id="c5" style='display:none' value="Higher Diploma of Human Resource Management">Higher Diploma of
               Human Resource Management</option>
            <option id="c6" style='display:none' value="Higher Diploma of Performing Arts">Higher Diploma of Performing
               Arts</option>
