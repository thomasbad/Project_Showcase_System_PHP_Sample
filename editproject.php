...
if(mysqli_num_rows($projresult) > 0){
   ...
   $_SESSION['projlink'] = $row['file_id'];
   $_SESSION['projtitle'] = $row['project_showcase'];
}else{
...
<div class="form-container">
   ...
   <form action="lib/projectupdate.php" method="post">
      ...
      <input class="input is-primary" type="text" name="projtitle" required placeholder="Enter your Project Title" value="<?php echo $_SESSION['projtitle'] ?>"><br>
      <label class="label" style="text-align:left">Project document link: </label>
      <input class="input is-primary" type="text" name="projlink" placeholder="Enter the link of your Project Documents for download" value="<?php echo $_SESSION['projlink'] ?>"><br><br>
