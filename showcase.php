  ...
  <div class="fix-bg">
    <div style="width:100%; padding: 80px 50px 20px;">
      ...
      <div style="height:350px; overflow:auto;">
       ...
       <br><a style="color: white;" href="editproject.php"><button class="button is-info is-fullwidth">Edit Your Project
          Information</button></a>
      <a style="color: black;" href="user_page.php"><button class="button is-warning is-fullwidth">Back to Previous
          Page</button></a>
    </div>
  </div>
</body>
