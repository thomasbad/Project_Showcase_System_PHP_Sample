	...
	<div class="container">
		...
		<div class="page-header">
			<h1 class="h2">&nbsp; List of Members<a class="btn btn-success" href="adduser.php"
					style="margin-left: 770px;"><span class="glyphicon glyphicon-user"></span>&nbsp; Add User</a></h1>
			<hr>
		</div>
		<div class="row">
			<?php
				...
				while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
					...
					<div class="col-xs-3" style="height: 500px">
						...
						<p class="page-header" align="center">
							<span>
								<a class="btn btn-primary" href="edituserform.php?edit_id=<?php echo $row['username']; ?>"><span
										class="glyphicon glyphicon-pencil"></span> Edit</a>
								<a class="btn btn-warning" href="?delete_id=<?php echo $row['username']; ?>"
