...
<div class="form-container">
   ...
   <form action="lib/profileupdate.php" method="post">
      ...
      <input class="input is-primary" type="text" name="fname" required placeholder="Enter your first name" value="<?php echo $_SESSION['first_name'] ?>">  
      <label class="label" style="text-align:left">Middle Name: </label>
      <input class="input is-primary" type="text" name="mname" placeholder="Enter your middle name" value="<?php echo $_SESSION['mid_name'] ?>">
      <label class="label" style="text-align:left">Last Name: </label>
      <input class="input is-primary" type="text" name="lname" required placeholder="Enter your last name" value="<?php echo $_SESSION['last_name'] ?>">
